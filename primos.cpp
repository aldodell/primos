...
int main(int argc, char *argv[])
{
	...
	argHdl.add(argument(3, (char *)"i", (char *)"list", (char *)"Show primes number list", (char *)""));
	argHdl.add(argument(4, (char *)"p", (char *)"process", (char *)"Calculate prime numbers", (char *)""));
	argHdl.add(argument(5, (char *)"l", (char *)"load", (char *)"Load table", (char *)""));
	argHdl.add(argument(6, (char *)"t", (char *)"time", (char *)"Time to update UI(seconds)", (char *)"s"));
	argHdl.add(argument(7, (char *)"d", (char *)"debug", (char *)"Debug level", (char *)"n"));
	argHdl.add(argument(8, (char *)"x", (char *)"factorize", (char *)"Open factorizer CLI", (char *)""));
	argHdl.add(argument(9, (char *)"z", (char *)"last", (char *)"Show last found prime number", (char *)""));
	argHdl.add(argument(10, (char *)"b", (char *)"begin", (char *)"Margin for some process", (char *)""));
	argHdl.add(argument(11, (char *)"e", (char *)"end", (char *)"Margin for some process", (char *)""));
	argHdl.add(argument(12, (char *)"r", (char *)"error", (char *)"Find errors", (char *)""));
